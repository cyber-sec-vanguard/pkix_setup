...
initialize(){
	...
	cd "pkix/$name" || exit	# In case cd fails, exit the program
...
"
	...
	printf "Next, let's change the format to PKCS#8 format, which is the 
...
"
	...
	printf "Users must now deliver their CSR to your csr/. From there, you can 
	sign them."
	echo "Scrip ends here."
	printf "Things to do next
